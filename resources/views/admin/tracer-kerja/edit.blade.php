...
@section('title', 'Edit Data Tracer Kerja')

@section('content')
    <div class="container mx-auto px-4 py-6">
        <h1 class="text-2xl font-bold mb-6">Edit Data Tracer Kerja</h1>

        <form action="{{ route('admin.tracer-kerja.update', $tracer->id_tracer_kerja) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <input type="text" name="tracer_kerja_pekerjaan" id="tracer_kerja_pekerjaan"
                    class="w-full border border-gray-300 rounded-lg p-3" value="{{ $tracer->tracer_kerja_pekerjaan }}"
                    required>
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="text" name="tracer_kerja_nama" id="tracer_kerja_nama"
                    class="w-full border border-gray-300 rounded-lg p-3" value="{{ $tracer->tracer_kerja_nama }}" required>
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="text" name="tracer_kerja_jabatan" id="tracer_kerja_jabatan"
                    class="w-full border border-gray-300 rounded-lg p-3" value="{{ $tracer->tracer_kerja_jabatan }}"
                    required>
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="text" name="tracer_kerja_status" id="tracer_kerja_status"
                    class="w-full border border-gray-300 rounded-lg p-3" value="{{ $tracer->tracer_kerja_status }}"
                    required>
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="text" name="tracer_kerja_lokasi" id="tracer_kerja_lokasi"
                    class="w-full border border-gray-300 rounded-lg p-3" value="{{ $tracer->tracer_kerja_lokasi }}"
                    required>
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="text" name="tracer_kerja_alamat" id="tracer_kerja_alamat"
                    class="w-full border border-gray-300 rounded-lg p-3" value="{{ $tracer->tracer_kerja_alamat }}"
                    required>
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="date" name="tracer_kerja_tgl_mulai" id="tracer_kerja_tgl_mulai"
                    class="w-full border border-gray-300 rounded-lg p-3" value="{{ $tracer->tracer_kerja_tgl_mulai }}"
                    required>
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="text" name="tracer_kerja_gaji" id="tracer_kerja_gaji"
                    class="w-full border border-gray-300 rounded-lg p-3" value="{{ $tracer->tracer_kerja_gaji }}">
            </div>
